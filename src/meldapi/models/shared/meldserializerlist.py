...
class MeldSerializerListOutput:
    ...
    management: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('management') }})
    management_agent_closer: MeldSerializerListManagementAgentCloser = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('management_agent_closer') }})
    managementappointment: MeldSerializerListManagementappointment = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('managementappointment') }})
    manager_canceller: MeldSerializerListManagerCanceller = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('manager_canceller') }})
    meld_expenditures: MeldSerializerListMeldExpenditures = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meld_expenditures') }})
    ...
    updated: datetime = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('updated'), 'encoder': utils.datetimeisoformat(False), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso') }})
    vendor_closer: MeldSerializerListVendorCloser = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vendor_closer') }})
    vendorappointment: MeldSerializerListVendorappointment = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vendorappointment') }})
