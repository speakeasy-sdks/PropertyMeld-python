...
from ..shared import meldinvoiceserializerdetail as shared_meldinvoiceserializerdetail
...
class InvoiceRetrieveResponse:
    ...
    meld_invoice_serializer_detail: Optional[shared_meldinvoiceserializerdetail.MeldInvoiceSerializerDetail] = dataclasses.field(default=None)
