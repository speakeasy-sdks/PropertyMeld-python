...
from ..shared import paginatedpropertygroupserializerlistlist as shared_paginatedpropertygroupserializerlistlist
...
class PropertyGroupListResponse:
    ...
    paginated_property_group_serializer_list_list: Optional[shared_paginatedpropertygroupserializerlistlist.PaginatedPropertyGroupSerializerListList] = dataclasses.field(default=None)
