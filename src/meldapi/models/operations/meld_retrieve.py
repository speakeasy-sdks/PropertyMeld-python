...
from ..shared import meldserializerdetail as shared_meldserializerdetail
...
class MeldRetrieveResponse:
    ...
    meld_serializer_detail: Optional[shared_meldserializerdetail.MeldSerializerDetailOutput] = dataclasses.field(default=None)
