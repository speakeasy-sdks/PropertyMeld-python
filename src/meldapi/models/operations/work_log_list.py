...
from ..shared import paginatedworkentryserializerlistlist as shared_paginatedworkentryserializerlistlist
...
class WorkLogListResponse:
    ...
    paginated_work_entry_serializer_list_list: Optional[shared_paginatedworkentryserializerlistlist.PaginatedWorkEntrySerializerListList] = dataclasses.field(default=None)
