...
from ..shared import buildingserializerdetail as shared_buildingserializerdetail
...
class BuildingRetrieveResponse:
    ...
    building_serializer_detail: Optional[shared_buildingserializerdetail.BuildingSerializerDetail] = dataclasses.field(default=None)
