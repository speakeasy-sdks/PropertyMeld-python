...
from ..shared import paginatedvendorlist as shared_paginatedvendorlist
...
class VendorListResponse:
    ...
    paginated_vendor_list: Optional[shared_paginatedvendorlist.PaginatedVendorList] = dataclasses.field(default=None)
