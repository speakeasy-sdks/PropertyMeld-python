...
from ..shared import paginatedprojectlistviewlist as shared_paginatedprojectlistviewlist
...
class ProjectListResponse:
    ...
    paginated_project_list_view_list: Optional[shared_paginatedprojectlistviewlist.PaginatedProjectListViewList] = dataclasses.field(default=None)
