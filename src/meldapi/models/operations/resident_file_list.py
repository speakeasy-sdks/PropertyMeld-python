...
from ..shared import paginatedtenantmeldfilelist as shared_paginatedtenantmeldfilelist
...
class ResidentFileListResponse:
    ...
    paginated_tenant_meld_file_list: Optional[shared_paginatedtenantmeldfilelist.PaginatedTenantMeldFileList] = dataclasses.field(default=None)
