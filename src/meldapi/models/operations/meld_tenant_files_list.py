...
from ..shared import paginatedpmapitenantmeldlist as shared_paginatedpmapitenantmeldlist
...
class MeldTenantFilesListResponse:
    ...
    paginated_pm_api_tenant_meld_list: Optional[shared_paginatedpmapitenantmeldlist.PaginatedPmAPITenantMeldList] = dataclasses.field(default=None)
