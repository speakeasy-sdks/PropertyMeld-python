...
from ..shared import paginatedvendormeldfilelist as shared_paginatedvendormeldfilelist
...
class VendorFileListResponse:
    ...
    paginated_vendor_meld_file_list: Optional[shared_paginatedvendormeldfilelist.PaginatedVendorMeldFileList] = dataclasses.field(default=None)
